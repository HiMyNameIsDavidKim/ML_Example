...
class SPRTransformer(nn.Module):
    def __init__(self, img_size=(720, 1280), patch_size=40, in_chans=2, embed_dim=1024, depth=8, num_heads=16,
        ...
        self.decoder_pred_g = nn.Linear(decoder_embed_dim, out_patch_size ** 2 * out_chans,
                                        bias=True)  # decoder to patch
        self.decoder_pred_rb = nn.Linear(decoder_embed_dim, (out_patch_size ** 2 * out_chans) // 2,
                                         bias=True)  # decoder to patch
