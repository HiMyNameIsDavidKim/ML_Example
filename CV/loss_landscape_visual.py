...
def visual_landscape():
    ...
    landscape_dataset = datasets.CIFAR10(root='./data', train=True, transform=transform, download=True)
    landscape_loader = DataLoader(dataset=landscape_dataset, batch_size=8, shuffle=False)

    inputs, targets = None, None
    for batch, (inputs, targets) in enumerate(landscape_loader):
        break
