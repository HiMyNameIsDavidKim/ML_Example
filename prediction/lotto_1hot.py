...
lotto_new_npy = './data/lotto_new_da4ta.npy'
step = 12
epochs = 77
lr = 0.0001
    ...
    def predict_test(self):
        ...
        for j in range(5):
            ...
            for i in range(len(y_pred)):
                ...
                truth = sorted(self.prob2num(self.y_test[i][0]))
                preds.append(pred)
                truths.append(truth)
...
class LottoServices(object):
    def __init__(self):
        ...
        self.model2 = f'./save/lotto_1hot/lotto_1hot_t4.h5'
        self.model3 = f'./save/lotto_1hot/lotto_1hot_t26.h5'
        self.model4 = f'./save/lotto_1hot/lotto_1hot_t52.h5'
        self.model5 = f'./save/lotto_1hot/lotto_1hot_t260.h5'
        self.list_model = [self.model1, self.model2, self.model3, self.model4, self.model5]
        self.list_step = [1, 4, 26, 52, 260]
        self.df = None
        self.x = None
