...
class StockDNNEnsemble(object):
    ...
    def process(self):
        ...
        self.np_read()
        self.process_dnn_ensemble(self.fit_refresh)
        self.pred_test(dnn_ensemble, x_test_dnn_en, y_test_dnn_en)
...
if __name__ == '__main__':
    StockDNNEnsemble(fit_refresh=False).process()