...
class StockLSTMEnsemble(object):
    ...
    def process(self):
        ...
        self.np_read()
        self.process_lstm_ensemble(self.fit_refresh)
        self.pred_test(lstm_ensemble, x_test_lstm_en, y_test_lstm_en)
...
if __name__ == '__main__':
    StockLSTMEnsemble(fit_refresh=False).process()